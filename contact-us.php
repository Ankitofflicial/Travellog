<?php
if (isset($_POST['sub'])) {
  $to = "ankitraj77390@gamil.com"; // this is your Email address
...
<head>
  ...
  <link rel="icon" type="image/png" href="C:\xampp\htdocs\Project\Mobile-Background\alps_favicon.png">
